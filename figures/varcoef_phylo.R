...
# subset data for varcoef
dat <- na.omit(dat[, c("species", "coef.of.var", "clade")])
...
varcoef <- setNames(dat$coef.of.var, dat$species)
map <- contMap(pruned.tree, varcoef, plot = FALSE)
